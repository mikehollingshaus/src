...
//        return;    
//        }
        CohortComponentModel ccm = udem.getWorkbench().getModel();
        Population[] allPops = ccm.getAllPops();
        Population p = allPops[7];
        ...
        XAxisMetric xmet = getXMetric(maxObservedValue);
